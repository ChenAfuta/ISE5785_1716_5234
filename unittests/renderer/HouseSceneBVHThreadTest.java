// renderer/HouseSceneBVHMyTest.java
package renderer;
...
public class HouseSceneBVHThreadTest {

    private final Scene scene = new Scene("House Scene BVH");
    ...
    public void streetScene() {
        ...
        camera.writeToImage("houseBVHThread");
    }

    private void addHouse(List<Intersectable> geometries) {
