...
/**
 * Test class for rendering a house scene with multithreading enabled.
 */
public class HouseSceneThreadsTest {

    private final Scene scene = new Scene("House Scene Thread Test");
    private final Camera.Builder cameraBuilder = Camera.getBuilder()
            .setRayTracer(scene, RayTracerType.SIMPLE);

    /**
     * Renders a house scene with full acceleration and multithreading enabled.
     */
    @Test
    public void HouseSceneFullAcceleration() {
        ...
        camera.writeToImage("HouseThreads");
    }
