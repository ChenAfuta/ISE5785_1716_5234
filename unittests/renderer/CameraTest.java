 ...
 * This class tests the construction of rays from the camera through the view plane.
 */
class CameraTest {

    /**
     * A {@link renderer.Camera.Builder} instance used to configure and build the camera for the tests.
     * The camera is configured with a default location at the origin, a direction facing -Z, and a view plane distance of 10.
     */
    ...
    /**
     * Tests the {@link renderer.Camera#constructRay(int, int, int, int)} method.
     * Verifies that rays are constructed correctly for various positions on the view plane.
     */
    @Test
